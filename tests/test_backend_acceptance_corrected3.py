...
def test_backend_acceptance_all_public_families(monkeypatch):
    ...
    player_match = variable_resolver.resolve_variable("successfulDribbles", season="2024-25", fixture_id="1", player_id="p1")
    team_match = variable_resolver.resolve_variable("goalsFor", season="2024-25", fixture_id="1", family="team_match", team_id="t1")
    player_season = variable_resolver.resolve_variable("appearances", season="2024-25", family="player_season", player_id="p1")
    squad = variable_resolver.resolve_variable("playerId", season="2024-25", family="squad", player_id="p1")
    fpl = variable_resolver.resolve_variable("total_points", season="2024-25", family="fpl", player_id="p1", gameweek="1")
    ...
    assert fpl["research_family"] == "FPL"
