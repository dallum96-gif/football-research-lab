...
def test_research_request_keeps_temporal_context_out_of_resolver_payload():
    request=research_access.ResearchRequest("successfulDribbles","2024-25","player_match",fixture_id="1",player_id="p1",as_of_date="2024-12-01",information_available_as_of="2024-12-01")
...
def test_discovery_and_result_contract_names_are_stable(monkeypatch):
    ...
    monkeypatch.setattr(research_access,"resolve_variable",lambda **kwargs:{"results":[{"value":1}],"coverage":{"source_rows":1,"matched_rows":1},"population":1,"source_rows":[{"value":1}],"limitations":[],"provenance":{"test":True}})
    result=research_access.query(research_access.ResearchRequest("successfulDribbles","2024-25","player_match",fixture_id="1",player_id="p1"))
