...
def test_current_defender_has_position_specific_radar() -> None:
...
def test_current_goalkeeper_has_position_specific_radar() -> None:
...
def test_current_forward_has_position_specific_radar() -> None:
