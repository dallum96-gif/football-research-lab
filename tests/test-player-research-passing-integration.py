...
def test_player_match_passing_overrides():
    original = player_research_player_match.player_match_evidence_for_records
    player_research_player_match.player_match_evidence_for_records = lambda rows: {
        "status": "VERIFIED",
    ...
    try:
        ...
        player_research_player_match.player_match_evidence_for_records = original
