...
def apply_theme():
    st.markdown(
        ...
        section[data-testid="stSidebar"] > div:first-child {
            ...
            padding-right: var(--frl-side-inset) !important;
            padding-bottom: 1.1rem !important;
            padding-left: var(--frl-side-inset) !important;
            margin: 0 !important;
        }
        ...
        section[data-testid="stSidebar"] .stButton > button:hover {
            ...
            background: rgba(232, 93, 63, 0.14) !important;
        }
        ...
        .frl-sidebar-section:first-child {
        ...
        div[data-baseweb="select"] > div {
            ...
            box-shadow: 0 2px 10px rgba(24,23,20,0.035) !important;
        }
        ...
        div[data-baseweb="select"] > div:focus-within {
            ...
            box-shadow: 0 0 0 2px rgba(232,93,63,0.10) !important;
        }
        ...
        div[data-baseweb="menu"] li:hover {
            background: rgba(232,93,63,0.09) !important;
        }
        ...
        .stButton > button {
            ...
            border-radius: 7px;
            box-shadow: 0 2px 8px rgba(24,23,20,0.035);
        }
        ...
        div[data-testid="stDataFrame"] {
            ...
            box-shadow: 0 3px 15px rgba(24,23,20,0.035);
        }
        </style>
        """,
