...
def _navigate(item_key: str) -> None:
    ...
    if item_key in TEAM_VIEW_TARGETS:
        st.session_state.pop("frl_team_view", None)
        st.session_state["_frl_team_view_target"] = TEAM_VIEW_TARGETS[item_key]
    elif item_key in PLAYER_VIEW_TARGETS:
        st.session_state.pop("frl_player_view", None)
        st.session_state["_frl_player_view_target"] = PLAYER_VIEW_TARGETS[item_key]
