        ...
        for row in player["_records"]:
            if str(
                ...
                result["_evidence"] = {
                    ...
                    "aggregation":
                        "SUM approved additive metrics; appearances count player-fixture rows with minutes > 0; per-90 from pooled totals / minutes × 90; optional rich projection joins by audited player code",
                    "rich_player_projection":
                        result.get(
                            "_rich_player_projection"
                        ),
                }
