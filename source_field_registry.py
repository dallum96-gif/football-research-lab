...
TEAM_PROMOTION_BATCH_V8_FIELDS = {
    ...
    "attBxLeft": "exposed",
    "attBxRight": "exposed",
    "attCmissHigh": "exposed",
    "attCmissHighRight": "exposed",
    "attCmissLeft": "exposed",
    "attCmissRight": "exposed",
    "attGoalLowCentre": "exposed",
    "attGoalLowLeft": "exposed",
    "attGoalLowRight": "exposed",
    "attHdMiss": "exposed",
    "attHdTarget": "exposed",
    "attHdTotal": "exposed",
    "attIboxBlocked": "exposed",
    "attIboxGoal": "exposed",
    "attIboxMiss": "exposed",
    "attIboxTarget": "exposed",
    "attLfGoal": "exposed",
    "attLfTarget": "exposed",
    "attLfTotal": "exposed",
    "attMissHigh": "exposed",
    "attMissHighLeft": "exposed",
    "attMissHighRight": "exposed",
    "attMissLeft": "exposed",
    "attMissRight": "exposed",
    "attOboxBlocked": "exposed",
    "attOboxGoal": "exposed",
    "attOboxMiss": "exposed",
    "attOboxTarget": "exposed",
    "attObxCentre": "exposed",
    "attObxLeft": "exposed",
    "attRfGoal": "exposed",
    "attRfTarget": "exposed",
    "attRfTotal": "exposed",
    "attSvHighCentre": "exposed",
    "attSvHighLeft": "exposed",
    "attSvHighRight": "exposed",
    "attSvLowCentre": "exposed",
    "attSvLowLeft": "exposed",
    "attSvLowRight": "exposed",
    "cleanSheet": "exposed",
    "goals": "exposed",
    "goalsConceded": "exposed",
    "goalsConcededIbox": "exposed",
}
...
PLAYER_SEASON_PROMOTION_BATCH_V1_FIELDS = {
    "attemptsFromSetPieces": "exposed",
    "awayGoals": "exposed",
    "backwardPasses": "exposed",
    "catches": "exposed",
    "cleanSheets": "exposed",
    "clearancesOffTheLine": "exposed",
    "cornersTakenInclShortCorners": "exposed",
    "cornersWon": "exposed",
    "crossesNotClaimed": "exposed",
    "duels": "exposed",
    "duelsLost": "exposed",
    "duelsWon": "exposed",
    "fiftyFifty": "retained",
    "forwardPasses": "exposed",
    "foulAttemptedTackle": "exposed",
    "foulWonPenalty": "exposed",
    "freekickTotal": "retained",
    "gkSuccessfulDistribution": "exposed",
    "gkUnsuccessfulDistribution": "exposed",
    "goalKicks": "exposed",
    "goalkeeperSmother": "exposed",
    "goalsConceded": "exposed",
    "goalsConcededInsideBox": "exposed",
    "goalsConcededOutsideBox": "exposed",
    "groundDuels": "exposed",
    "groundDuelsLost": "exposed",
    "groundDuelsWon": "exposed",
    "handballsConceded": "exposed",
    "headedGoals": "exposed",
    "hitWoodwork": "exposed",
    "homeGoals": "exposed",
    "iboxBlocked": "exposed",
    "lastPlayerTackle": "exposed",
    "leftFootGoals": "exposed",
    "nationality": "exposed",
    "oboxBlocked": "exposed",
    "offsides": "exposed",
    "openPlayPasses": "exposed",
    "overruns": "exposed",
    "ownGoalScored": "exposed",
    "penaltiesConceded": "exposed",
    "penaltiesFaced": "exposed",
    "penaltiesSaved": "exposed",
    "penaltiesTaken": "exposed",
    "penaltyGoals": "exposed",
    "penaltyGoalsConceded": "exposed",
    "punches": "exposed",
    "recoveries": "exposed",
    "redCards2ndYellow": "exposed",
    "rightFootGoals": "exposed",
    "savesFromPenalty": "exposed",
    "savesMade": "exposed",
    "savesMadeCaught": "exposed",
    "savesMadeFromOutsideBox": "exposed",
    "savesMadeParried": "exposed",
    "setPiecesGoals": "exposed",
    "shotsOffTargetIncWoodwork": "exposed",
    "shotsOnTargetOutsideBox": "exposed",
    "substituteOff": "exposed",
    "substituteOn": "exposed",
    "successfulCornersIntoBox": "exposed",
    "successfulCrossesAndCorners": "exposed",
    "successfulCrossesOpenPlay": "exposed",
    "successfulFiftyFifty": "retained",
    "successfulLaunches": "exposed",
    "successfulLayoffs": "exposed",
    "successfulPassesOppositionHalf": "exposed",
    "successfulPassesOwnHalf": "exposed",
    "successfulShortPasses": "exposed",
    "throughBalls": "exposed",
    "throwInsToOppositionPlayer": "exposed",
    "throwInsToOwnPlayer": "exposed",
    "totalClearances": "exposed",
    "totalFoulsConceded": "exposed",
    "totalFoulsWon": "exposed",
    "totalLossesOfPossession": "exposed",
    "totalPasses": "exposed",
    "totalShots": "exposed",
    "totalTackles": "exposed",
    "totalTouchesInOppositionBox": "exposed",
    "totalUnsuccessfulPassesExclCrossesAndCorners": "exposed",
    "unsuccessfulCornersIntoBox": "exposed",
    "unsuccessfulCrossesAndCorners": "exposed",
    "unsuccessfulCrossesOpenPlay": "exposed",
    "unsuccessfulDribbles": "restricted",
    "unsuccessfulLaunches": "exposed",
    "unsuccessfulLayoffs": "exposed",
    "unsuccessfulLongPasses": "exposed",
    "unsuccessfulPassesOwnHalf": "exposed",
    "unsuccessfulShortPasses": "exposed",
    "winningGoal": "retained",
    "yellowCards": "exposed",
}
...
PLAYER_SEASON_FINAL_SEMANTIC_RESIDUE_FIELDS = {
    "iboxTarget": "exposed",
    "leftsidePasses": "exposed",
    "oboxTarget": "exposed",
    "rightsidePasses": "exposed",
    "savesMadeFromInsideBox": "exposed",
    "shotsOnTargetInBox": "exposed",
    "straightRedCards": "exposed",
    "successfulLongPasses": "exposed",
    "tacklesLost": "exposed",
    "timesTackled": "exposed",
    "totalRedCards": "exposed",
    "blocks": "retained",
    "drops": "retained",
    "keyPassesAttemptAssists": "retained",
    "otherGoals": "retained",
    "putthroughBlockedDistribution": "retained",
    "putthroughBlockedDistributionWon": "retained",
    "secondGoalAssists": "retained",
}
...
SOURCE_FIELD_REGISTRY = (
    ...
    + _build_family("player_season", PLAYER_SEASON_FIELDS | PLAYER_SEASON_PROMOTION_BATCH_V1_FIELDS | PLAYER_SEASON_FINAL_SEMANTIC_RESIDUE_FIELDS)
