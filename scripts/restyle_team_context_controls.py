...
TARGET = ROOT / "gui" / "team_research_ui_v8.py"
...
if not match:
    raise RuntimeError(f"Expected selector block not found in {TARGET}; refusing to patch.")
...
print("TARGET: team_research_ui_v8.py")
...
print("SYNTAX: team_research_ui_v8.py valid")
